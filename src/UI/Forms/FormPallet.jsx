...
export default function FormPallet() {
    ...
    return <form onSubmit={handleSubmit} className={style.Form}>
        ...
        <div className={style.user__container}>
            <InputPhoneNumber name="userPhone" value={value.userPhone} handleInput={handleInput} placeholder="Введите номер телефона"/>            <input type="text" name="userName" value={value.userName} onChange={(e) => handleInput(e)} className={style.user__input} placeholder="Введите имя"/>
